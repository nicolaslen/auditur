    ...
    public class BSPNroOPs : IReport<BSPNroOP>
    {
        public List<BSPNroOP> Generar(Semana oSemana)
        {
            ...
            foreach (BSP_Ticket oBSP_Ticket in lstTickets)
            {
                ...
                oBSPNroOP.BoletoNro = !oBSP_Ticket.Concepto.Tipo.Equals('R') ? oBSP_Ticket.NroDocumento.ToString() : oBSP_Ticket.Detalle.Find(x => x.Observaciones.Substring(0, 2) == "RF").Observaciones.Substring(5, 10);
